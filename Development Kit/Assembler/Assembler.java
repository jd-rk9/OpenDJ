...
public class Assembler {
    ...
    static {
        //put all predefined variables into a HashMap
        ...
        //determine all table options for A into a HashMap,a=0
        ...
        //determine all table options for M into a HashMap,a=1
                        ...
                        if (cMap.containsKey(varName)){
                            ...
                            if (p.matcher(varName).find()) {
                                ...
                                if (symbols.containsKey(varName)) {
                                    ...
                                    //if an overflow occurs, give "out of memory" exception
                                    if (addressDec >= 16384) {
